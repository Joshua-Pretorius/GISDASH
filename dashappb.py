...
# display the airline data in a chart
...
# display the airport data in a chart and map
st.header("Airport Data")
st.write(airports)
st.subheader("Airport Count by Country")
airport_counts = airports.groupby("Country").size().reset
